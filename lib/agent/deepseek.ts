...
export async function askDeepSeek(
  ...
  const systemPrompt = [
    ...
    "Do not include raw website URLs (http or https links) in answer text. Use the provided action buttons for navigation, downloads, and contact options.",
    "When a visitor asks how to reach Abdulelah, hire him, or work with him, share the contact email that matches their intent using the CONTACT ROUTING list, and you may write that email address directly in the answer. Use jobs@abdulelah.de for recruitment and roles, business@abdulelah.de for consulting and business, contact@abdulelah.de for general questions, and me@abdulelah.de when the intent is unclear. Abdulelah has no public phone number, so never provide one.",
