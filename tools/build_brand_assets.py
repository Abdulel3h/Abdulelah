#!/usr/bin/env python3
"""Generate the branding assets for Abdulelah.de.
...
NAME = "Abdulelah.de"
EYEBROW = "AI product · bilingual web"
LINE = "A portfolio you can ask."
DETAIL = "Next.js · typed project facts · server-side AI assistant"
DETAIL_SHORT = "Next.js · typed facts · AI assistant"
STATUS = "Deployed product"
STATUS_SHORT = "Deployed"
OWNER = "Abdulelah Alkhathami"
CHIPS = ["Bilingual", "Typed project facts", "Embedded assistant"]
NAME_SIZE_COVER = 78
NAME_SIZE_SOCIAL = 92
DESC = (    "Abdulelah.de — two interlocking translucent forms turning around one shared luminous "
    "core, exchanging light in both directions.")
...
def sculpture(cx: float, cy: float, scale: float = 1.0) -> str:
    """Two forms turning around one shared source of truth."""
