...
export const blogText = {
  en: {
    ...
    ctaBody:
      "Continue from practical ideas into project case studies, ask Abdulelah's guide about a topic, or download the CV that fits the role.",
    viewProjects: "View Projects",
    askAgent: "Ask Abdulelah",
    downloadResume: "Download the Engineer CV",
  ...
  ar: {
    ...
    ctaBody:
      "انتقل من الأفكار العملية إلى دراسات حالة المشاريع، أو اسأل دليل عبدالإله عن موضوع، أو حمّل نسخة السيرة المناسبة للدور.",
    viewProjects: "استعرض المشاريع",
    askAgent: "اسأل دليل عبدالإله",
    downloadResume: "تنزيل نسخة المهندس (CV)",
    ...
    continueBody:
      "استخدم دليل عبدالإله لاستكشاف هذا الموضوع بسياقه، أو انتقل لدراسات حالة المشاريع اللي توضح التفكير التطبيقي في الـ AI.",
    askAboutTopic: "اسأل دليل عبدالإله عن هذا الموضوع",
