...
Two interlocking translucent forms turn around one shared luminous core, exchanging light in both directions - the site and the assistant reading from the same source of truth.
