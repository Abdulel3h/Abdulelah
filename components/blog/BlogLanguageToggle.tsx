...
export function BlogLanguageToggle() {
  ...
  return (
    <div
      ...
      className="fixed bottom-[calc(env(safe-area-inset-bottom)+5.25rem)] left-5 z-40 flex items-center gap-1 rounded-full border border-white/10 bg-ink-900/90 p-1.5 shadow-[0_14px_44px_rgba(10,10,11,0.5)] backdrop-blur-md sm:bottom-auto sm:left-4 sm:top-1/2 sm:-translate-y-1/2 sm:flex-col sm:backdrop-blur-2xl"
    >
      <span
