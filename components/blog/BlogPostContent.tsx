    ...
    >
      <section className="container-shell pt-12 sm:pt-16 lg:pt-20">
        ...
        <div className="premium-panel p-6 sm:p-8 lg:p-10">
          ...
          <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-accent/15 blur-3xl" aria-hidden="true" />
          <div className="relative max-w-5xl">
            <div className="flex flex-wrap gap-2">
              <Badge variant="sky">{view.categoryLabel}</Badge>
              <Badge variant="gold">{view.sourceLabel}</Badge>
            </div>
            <h1 className="mt-6 text-balance text-4xl font-semibold leading-tight text-paper sm:text-5xl lg:text-6xl">
              {view.title}
            </h1>
            <p className="mt-6 max-w-4xl text-base leading-8 text-paper-dim sm:text-lg">
              {view.subtitle}
            </p>
      ...
      <section className="container-shell section-space">
        ...
        <Link
          href="/blog"
          className="focus-ring mt-9 inline-flex items-center gap-2 rounded text-sm font-semibold text-accent transition hover:text-paper"
        >
          {text.browseAll}
